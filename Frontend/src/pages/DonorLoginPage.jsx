      ...
      <div className="flex-1 flex flex-col justify-center py-12 px-6 sm:px-12 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-md">
          ...
          <form action="#" method="POST" className="space-y-6 bg-white p-8 rounded-lg shadow-sm border border-slate-200">
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1.5">Facility / Corporate ID</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Building2 className="h-5 w-5 text-slate-400" />
                </div>
                <input type="text" required className="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded focus:ring-1 focus:ring-primary-500 transition-colors outline-none text-slate-900" placeholder="e.g. CORP-NYC-902" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" required className="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded focus:ring-1 focus:ring-primary-500 transition-colors outline-none text-slate-900" placeholder="••••••••" />
              </div>
            </div>
            ...
            <div className="pt-2">
              <Link to="/donor/dashboard" className="w-full flex justify-center items-center gap-2 py-3 px-4 rounded text-sm font-bold text-white bg-primary-700 hover:bg-primary-800 transition-colors">
